                ...
                <div class="col-md-12 col-lg-8 ptb-50 pr-30 pr-md-15">
                    <div class="row">
                        @foreach($items as $item)
                            <div class="item col-sm-6 col-md-6 col-lg-6 col-xl-4 mb-30" style="cursor:pointer"  data-url="<?php echo url('/store/'.$item->slug) ?>" >
                                        ...
                                        <div class="plr-25 ptb-15 h-50">
                                            <div class="dplay-tbl">
                                                <div class="dplay-tbl-cell">
                                                    ...
                                                    <h4 class="mtb-10">
                                                        <a href="<?php echo url('/store/'.$item->slug) ?>"><b>{{$item->subtitle}}</b></a></h4>
